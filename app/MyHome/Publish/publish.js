...
class ReadMessage extends React.Component {
    ...
    saveTradeMarket = ()=>{
        let {goodsNo,model,content,price,saleNum,file} = this.state
    ...
    render(){
        ...
        let {pics,picsIndex,ordStatu,handelMsg,changeMsg,unreadData,readData,refreshing,} = this.state;
                                            ...
                                            <View>
                                                <ScrollView style={{maxHeight:Dimensions.get('window').height-200}}>
                                                    <View style={{padding:10,paddingBottom:this.state.padd}}>
                                                        ...
                                                        <View style={styles.a}>
                                                            <Text style={styles.f}><Text style={{color:"red"}}>*</Text>型号:</Text>
                                                            <View style={[styles.b,{flex:3}]}>
                                                                <TextInput
                                            ...
                                            <View style={{flex:4}}>
                                                ...
                                                <View style={{marginTop:5,flexDirection:"row"}}>
                                                    {item.images.map((imgs,index)=>
                                                        <TouchableHighlight underlayColor="transparent" onPress={()=>{this.seePic(item.images,index)}} style={{width:'30%',marginRight:5}} key={index}>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({item}) => (  //渲染列表的方式
                                        ...
                                        <View style={{flexDirection:"row",justifyContent:"space-between",padding:10,borderBottomColor:"#ccc",borderBottomWidth:1}}>
                                            ...
                                            <TouchableHighlight underlayColor="transparent" onPress={()=>{this.publishItem(item)}}  style={{flex:1,justifyContent:"center"}}>
